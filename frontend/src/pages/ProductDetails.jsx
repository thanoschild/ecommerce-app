    ...
    <div className="container mx-auto p-4">
      <div className="min-h-[200px] flex flex-col lg:flex-row gap-4">
        <div className="h-96 flex flex-col lg:flex-row-reverse gap-4 items-center">
          <div className="h-[3=400px] w-[300px] lg:h-96 lg:w-96 bg-slate-200 relative p-2">
            <img
              src={activeImage}
            ...
            {/**product zoom */}
            {zoomImage && (
              <div className="hidden lg:block absolute min-w-[500px] overflow-hidden min-h-[500px] bg-slate-200 p-1 -right-[520px] top-0">
                <div
        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-1 mt-5">
            ...
            <div>
              <p className="text-slate-600 font-bold my-1">Description : </p>
